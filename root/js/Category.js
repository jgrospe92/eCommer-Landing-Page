...
function showItemInCart(){
    ...
    let content = '<div id="cart-table"><table class="table-sm table-responsive-sm table table-striped">';
        content += '<thead class="table-dark text-center"><tr><th scope="col">Item ID</th><th scope="col">Title</th>';
    ...
    for (const item of cart){
        ...
        table += `<td id="moreDetails" class="text-center"><button onclick="removeFromCart(${counter});" class="mb-2 mb-lg-0 btn btn-danger ">REMOVE</button>`;
